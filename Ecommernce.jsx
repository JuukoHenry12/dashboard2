  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-2 bg-hero-pattern bg-no-repeat bg-cover bg-center">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
       ...
       ">
         <div className='flex justify-between'>
          ...
          <div className='mt-10 flex group flex-wrap justify-center'>
